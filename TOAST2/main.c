...
//PID
	...
	heatPID.Ki=-.04; //v2 = -.05 v3= .04 v4=0.1
	heatPID.Kd=-4000000; // was 500000 v2=-5000000 v3=-2000000 v4= -6000000
...
//	    	chprintf((BaseChannel *)&SD1, "%d: Preheat 50%  Temp: %d deg\r\n", seconds_counter, temp_degc);
    ...
    if(running == TRUE)
    	...
    	//Active running case
    	if (seconds_counter < 180) {  //We have our temp profile defined for 203 seconds, use first 180 then broil
