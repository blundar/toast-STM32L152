...
#define GPIOA               ((GPIO_TypeDef_ST*) GPIOA_BASE)
#define GPIOB               ((GPIO_TypeDef_ST*) GPIOB_BASE)
#define GPIOC               ((GPIO_TypeDef_ST*) GPIOC_BASE)
#define GPIOD               ((GPIO_TypeDef_ST*) GPIOD_BASE)
#define GPIOE               ((GPIO_TypeDef_ST*) GPIOE_BASE)
#define GPIOH               ((GPIO_TypeDef_ST*) GPIOH_BASE)
